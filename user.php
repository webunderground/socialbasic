...
<div class="wrapper">
	...
	<div class="maincontent">
    	...
    	<div class="logo"><img src="img/basic.png" width="379" height="200" alt="webdesigntuts+ logo"></div>
...
<?php 
 ...
 echo "<a href='user.php?tag=" . $fila['usuario'] . "'>" . $fila['usuario'] . "</a><br/> " . $fila['fecha'] . " ";
...
?> 
     ...
     <p><strong>social basic</strong></p>
    ...
    <div class="tabHeader">profile</div>
